...
@DomEvent("event-create-backend")
public class EventCreateEvent extends ComponentEvent<RoomDetail> {
     ...
     */
    public EventCreateEvent(RoomDetail source, boolean fromClient,
